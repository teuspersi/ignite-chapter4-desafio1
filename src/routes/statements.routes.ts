...
import { MakeTransferController } from "../modules/statements/useCases/createStatement/MakeTransferController";
...
statementRouter.post("/transfers/:receiver_id", makeTransferController.execute);
